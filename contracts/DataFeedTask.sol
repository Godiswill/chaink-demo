...
contract DataFeedTask {
     ...
     * 获得 link/usd 的价格数据
     */
    function getLinkLatestPrice() public view returns (int256 price) {
     ...
     * 获得 btc/usd 的价格数据
     */
    function getBtcLatestPrice() public view returns (int256 price) {
        //在此添加并且修改 solidity 代码
     ...
     * 获得 eth/usd 的价格数据
     */
    function getEthLatestPrice() public view returns (int256 price) {
        //在此添加并且修改 solidity 代码
